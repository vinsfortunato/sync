...
public class ChartsRecord extends UpdatableRecordImpl<ChartsRecord> implements Record10<String, Integer, String, String, Integer, String, String, String, String, String> {

    private static final long serialVersionUID = -1636537857;
    ...
    /**
     * Setter for <code>charts.notes</code>.
     */
    ...
    /**
     * Getter for <code>charts.notes</code>.
     */
     ...
     */
    @Override
    public Row10<String, Integer, String, String, Integer, String, String, String, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row10<String, Integer, String, String, Integer, String, String, String, String, String> valuesRow() {
     ...
     */
    @Override
    public ChartsRecord value10(String value) {
        setNotes(value);
        return this;
    }
     ...
     */
    @Override
    public ChartsRecord values(String value1, Integer value2, String value3, String value4, Integer value5, String value6, String value7, String value8, String value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ChartsRecord(String id, Integer songId, String hash, String difficultyClass, Integer difficultyMeter, String displayBpm, String name, String description, String credit, String notes) {
        super(Charts.CHARTS);
