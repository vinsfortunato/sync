...
import net.touchmania.game.util.ui.SoundLoader;
import net.touchmania.game.util.xml.XmlParseException;

public abstract class XmlSoundResolver extends XmlReferenceValueResolver<SoundLoader> {
    @Override
    ...
    @Override
    public SoundLoader resolveValue(String value) throws XmlParseException {
    ...
    public static XmlSoundResolver from(final ResourceProvider provider) {
        return new XmlSoundResolver() {
            @Override
            public SoundLoader resolveReference(String resourceId) {
